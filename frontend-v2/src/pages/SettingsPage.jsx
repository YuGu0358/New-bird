...
const OPTIONAL_KEYS = [
  ...
  { key: 'PINE_SEEDS_DIR',       labelKey: 'settings.labels.pineSeedsDir',       hintKey: 'settings.labels.pineSeedsDirHint',       required: false },
  { key: 'PINE_SEEDS_REPO_URL',  labelKey: 'settings.labels.pineSeedsRepoUrl',  hintKey: 'settings.labels.pineSeedsRepoUrlHint',  required: false },
  { key: 'PINE_SEEDS_WATCHLIST', labelKey: 'settings.labels.pineSeedsWatchlist', hintKey: 'settings.labels.pineSeedsWatchlistHint', required: false },
